  ...
  return (
    ...
    >
      ...
      <main className="relative max-w-6xl mx-auto px-6 py-12">
        {/* Scarcity Bar - only show when slots available */}
        {!slotsExhausted && (
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-zinc-400 max-w-2xl mx-auto">
            {slotsExhausted
              ? "Ative seu período de teste grátis de 14 dias e conheça todas as funcionalidades do Autevo."
              : "Você garantiu uma das vagas reservadas. Ative agora para travar seu desconto vitalício."}
          </p>
        </div>

        {slotsExhausted ? (
          /* Slots Exhausted - Simple Trial Activation */
          <div className="max-w-lg mx-auto">
            <div className="bg-gradient-to-b from-indigo-500/10 to-transparent border border-indigo-500/30 rounded-2xl p-8 backdrop-blur-sm text-center">
              <div className="mb-6">
                <div className="h-16 w-16 mx-auto rounded-2xl bg-indigo-500/20 flex items-center justify-center mb-4">
                ...
                <p className="text-zinc-400">
                  Acesse todas as funcionalidades do Autevo sem compromisso.
                </p>
              </div>
              ...
              <Button
                ...
                className="w-full bg-gradient-to-r from-indigo-600 to-indigo-500 hover:from-indigo-500 hover:to-indigo-400 text-white font-semibold px-6 py-4 rounded-xl transition-all shadow-lg shadow-indigo-500/25 text-lg"
              >
              ...
              <p className="text-xs text-zinc-500 mt-4">
                Após o período de teste, o plano custa R$ {REGULAR_PRICE}/mês
              </p>
            </div>
            ...
            <div className="grid grid-cols-2 gap-3 mt-8">
              {FEATURES.slice(0, 4).map((feature) => (
                ...
                >
                  <feature.icon className="h-5 w-5 text-indigo-400 shrink-0" />
          ...
          /* Founder Slots Available - Full Experience */
