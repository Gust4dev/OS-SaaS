  ...
  return (
    <div className="w-full max-w-lg mx-auto">
      ...
      <Card>
        ...
        <CardContent>
          <form id="setup-form" onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
            ...
            {step === 1 && (
              <div className="space-y-4 animate-in fade-in slide-in-from-right-4 duration-300">
                <div className="space-y-2">
                  ...
                  <p className="text-xs text-muted-foreground">O nome é gerenciado pela sua conta de acesso.</p>
                </div>
                ...
                <div className="bg-blue-500/10 p-4 rounded-lg border border-blue-500/20">
                    <p className="text-sm text-blue-600">
                        <strong>Nota:</strong> Como criador da conta, você terá acesso administrativo total (Role: OWNER).
                    </p>
                </div>
              </div>
            )}
              ...
              <div className="space-y-4 animate-in fade-in slide-in-from-right-4 duration-300">
                ...
                <div className="space-y-2">
                  ...
                  <Input 
                    ...
                    {...form.register('logo')} 
                  />
                  <p className="text-xs text-muted-foreground">Você poderá fazer upload de uma imagem depois nas configurações.</p>
                </div>
              </div>
            )}
